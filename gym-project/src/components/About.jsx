      ...
      <div className='h-full w-3/4 relative'>
        ...
        <div className='h-full w-full absolute flex'>
          <div className='w-1/2 h-full flex flex-col'>
            <div className='h-1/2 w-full flex flex-col items-center justify-end  pb-5'>
            ...
            <div className='h-1/2 w-full flex justify-center items-center'>
              <div className='h-3/4 w-full flex justify-center relative'>
                <img className='h-full w-1/3 object-cover absolute z-20 left-20 rounded-lg border-2 shadow-2xl shadow-black' src="assets/women/w4.jpg" alt="" />
                <img className='h-full w-1/3 object-cover absolute z-30  rounded-lg border-2 shadow-2xl shadow-black ' src="assets/women/w3.jpg" alt="" />
                <img className='h-full w-1/3 object-cover absolute z-10 right-20  rounded-lg border-2 shadow-2xl shadow-black' src="assets/women/w6.jpg" alt="" />
              </div>
            </div>
