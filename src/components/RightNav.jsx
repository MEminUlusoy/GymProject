...
function RightNav({rightNav,setRightNav}) {
  return (
    <div className={`right-[0px] w-[300px]  h-[calc(100vh-100px)]  absolute  flex items-start justify-center top-[100px] bg-black transition-all duration-300 ease-in ${rightNav ? "block transition-all duration-300 ease-in  z-40" : "hidden transition-all duration-300 ease-in z-0"} `}>
